...
export default async function DashboardPage() {
  ...
  return (
    <div className="mx-auto max-w-7xl p-4 sm:p-6">
      <section className="mb-5 flex flex-col gap-2 sm:mb-6 sm:flex-row sm:items-end sm:justify-between">
        <div>
      ...
      <section className="mb-6 sm:mb-8">
        <div className="mb-4 flex items-center justify-between gap-3">
          <h3 className="text-xl font-bold sm:text-2xl">Current Standings</h3>
        </div>
                  ...
                  <div key={game.id} className="rounded-xl border border-slate-200 p-4">
                    ...
                    <div className="mt-2 flex flex-col gap-2 text-base font-semibold text-slate-900 sm:flex-row sm:flex-wrap sm:items-center">
                      <div className="flex items-center gap-2">
                        <TeamLogo
                          teamName={teamMap.get(game.winning_team_id ?? "") ?? "TBD"}
                          size={24}
                        />
                      ...
                      <div className="flex items-center gap-2">
                        <TeamLogo
                          teamName={teamMap.get(game.losing_team_id ?? "") ?? "TBD"}
                          size={24}
                        />
